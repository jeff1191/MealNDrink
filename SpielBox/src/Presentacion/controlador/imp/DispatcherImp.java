...
public class DispatcherImp extends Dispatcher {
	...
	public void dispatch(Integer evento, Object datos) {
		...
		case Eventos.ANADIR_VIDEOJUEGO_BIBLIOTECA: 
			JOptionPane.showMessageDialog(new JPanel(), "Videojuego A�adido correctamente.");
		...
		case Eventos.ANADIR_PROGRAMA_PLATAFORMA:
			JOptionPane.showMessageDialog(null, "Programa a�adido correctamente de la plataforma");
        break;
