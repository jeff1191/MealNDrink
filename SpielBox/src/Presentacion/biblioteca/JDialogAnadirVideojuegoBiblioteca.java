...
public class JDialogAnadirVideojuegoBiblioteca extends JDialog {

	public JDialogAnadirVideojuegoBiblioteca(){
		initComponents();
	}
	...
	private void initComponents() {
        ...
        setTitle("Anadir videojuego a biblioteca");
        ...
        jButtonAnadir.addActionListener(new ActionListener() {			
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				ControladorAplicacion.getInstance().accionCommand(Eventos.ANADIR_VIDEOJUEGO_BIBLIOTECA, transferVideojuego_biblioteca);
				setVisible(false);
			}
        });
