...
INSERT INTO USUARIO VALUES (1, 'seLoTraga@cuca.com', '/img/users/admin_jeff.jpg', 'Jeff', 'admin', '974532165')
INSERT INTO USUARIO VALUES (2, 'topeGuay@home.com', '/img/users/user_josemi.jpg', 'Josemi', 'user','663219078')
INSERT INTO USUARIO VALUES (3, 'loTengoTodoPapi@linux.com', '/img/users/local_dani.jpg', 'Dani', 'local', '974511165')
INSERT INTO USUARIO VALUES (4, 'aPorEllo@chacho.com', '/img/users/local_juanlu.jpg', 'Juan Lu', 'local', '974532177')
INSERT INTO USUARIO VALUES (5, 'superIncreible@rubias.com', '/img/users/local_maria.jpg', 'Maria', 'local', '974532177')
INSERT INTO USUARIO VALUES (6, 'user12@fake.com', '/img/users/user_fulano.jpg', 'Fulano', 'user', '663219222')
INSERT INTO USUARIO VALUES (7, 'user1234@fake.com', '/img/users/user_mengano.jpg', 'Mengano', 'user', '663256781')
INSERT INTO USUARIO VALUES (8, 'bach1243@chachi.com', '/img/users/user_rosita.jpg', 'Rosita', 'user', '655213078')
INSERT INTO USUARIO VALUES (9, 'dormirlonSensual@snoopy.com', '/img/users/user_pablito.jpg', 'Pablito', 'user', '676439012')
INSERT INTO USUARIO VALUES (10, 'callMeMaybe@tux.com', '/img/users/user_eloisa.jpg', 'Eloisa', 'user', '663214658')
...
/*( "ID", "CAPACIDADACTUAL", "CAPACIDAD_TOTAL", "FECHA_LIMITE", "FOTO", "NOMBRE", "LOCAL")*/
INSERT INTO OFERTA VALUES (1, 0, 10, TO_TIMESTAMP('2015-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/bistro_copas4.jpg', 'Copas a 4€', 1)
INSERT INTO OFERTA VALUES (2, 0, 11, TO_TIMESTAMP('2015-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/bistro_riconudo.jpg', 'Riconudo', 1)
INSERT INTO OFERTA VALUES (3, 0, 30, TO_TIMESTAMP('2015-07-02 06:14', 'YYYY-MM-DD HH24:MI:'), '/img/offers/bistro_pareja.jpg', 'Ven con tu pareja', 1)
INSERT INTO OFERTA VALUES (4, 0, 20, TO_TIMESTAMP('2016-07-02 06:14', 'YYYY-MM-DD HH24:MI:'), '/img/offers/tapas_cumple.jpg', 'Celebra tu cumple', 2)
INSERT INTO OFERTA VALUES (5, 0, 14, TO_TIMESTAMP('2015-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/tapas_flow.jpg', 'Flow non stop', 2)
INSERT INTO OFERTA VALUES (6, 0, 13, TO_TIMESTAMP('2015-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/cubosytapas_tapasgratis.jpg', 'Tapas gratis', 3)
INSERT INTO OFERTA VALUES (7, 0, 18, TO_TIMESTAMP('2015-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/azampar_comeloquequieras.jpg', 'Come lo que quieras', 4)
INSERT INTO OFERTA VALUES (8, 0, 22, TO_TIMESTAMP('2016-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/azampar_rellenarbebida.jpg', 'Rellena tu bebida', 4)
INSERT INTO OFERTA VALUES (9, 0, 78, TO_TIMESTAMP('2017-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/100sabrositos_alitasconsumicion.jpg', 'Alitas con tu primera consumicion', 5)
INSERT INTO OFERTA VALUES (10, 0, 9, TO_TIMESTAMP('2015-07-02 06:14', 'YYYY-MM-DD HH24:MI'), '/img/offers/bistro_inivitar.jpg', 'Invitar es facil', 1)
